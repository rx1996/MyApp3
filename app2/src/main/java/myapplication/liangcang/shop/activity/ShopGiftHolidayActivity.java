...
import myapplication.liangcang.shop.adapter.ShopGiftHolidayAdapter;
import myapplication.liangcang.shop.bean.GiftHolidayInfo;
import myapplication.liangcang.utils.Constants;
import okhttp3.Call;

public class ShopGiftHolidayActivity extends BaseActivity {
    ...
    private ShopGiftHolidayAdapter adapter;
    ...
    public void initData() {
        getDataFromNet(Constants.BASE_URL_SHOP_GIF_HOLIDAY);
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_shop_gift_holiday;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_special:
                ...
                break;
            case R.id.base_shop:
                startActivity(new Intent(ShopGiftHolidayActivity.this, LoginActivity.class));
                break;
            case R.id.rl_shuaixuan:
                Toast.makeText(ShopGiftHolidayActivity.this, "筛选", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    private void processData(String json) {
        GiftHolidayInfo giftHolidayInfo = JSON.parseObject(json, GiftHolidayInfo.class);
        List<GiftHolidayInfo.DataBean.ItemsBean> datas = giftHolidayInfo.getData().getItems();
        adapter = new ShopGiftHolidayAdapter(this, datas);
