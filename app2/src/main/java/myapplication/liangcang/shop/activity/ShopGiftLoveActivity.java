...
import myapplication.liangcang.shop.adapter.ShopGiftLoveAdapter;
import myapplication.liangcang.shop.bean.GiftLoveInfo;
import myapplication.liangcang.utils.Constants;
import okhttp3.Call;

public class ShopGiftLoveActivity extends BaseActivity {
    ...
    private ShopGiftLoveAdapter adapter;
    ...
    public void initData() {
        getDataFromNet(Constants.BASE_URL_SHOP_GIF_LOVE);
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_shop_gift_love;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_special:
                ...
                break;
            case R.id.base_shop:
                startActivity(new Intent(ShopGiftLoveActivity.this, LoginActivity.class));
                break;
            case R.id.rl_shuaixuan:
                Toast.makeText(ShopGiftLoveActivity.this, "筛选", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    private void processData(String json) {
        GiftLoveInfo fiftLoveInfo = JSON.parseObject(json, GiftLoveInfo.class);
        List<GiftLoveInfo.DataBean.ItemsBean> datas =fiftLoveInfo.getData().getItems();
        adapter = new ShopGiftLoveAdapter(this, datas);
