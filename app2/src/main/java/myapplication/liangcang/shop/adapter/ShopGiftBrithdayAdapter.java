...
public class ShopGiftBrithdayAdapter extends RecyclerView.Adapter<ShopGiftBrithdayAdapter.MyViewHolder> {
    private final Context context;
    private final List<ShopGiftBrithdayInfo.DataBean.ItemsBean> datas;

    public ShopGiftBrithdayAdapter(Context context, List<ShopGiftBrithdayInfo.DataBean.ItemsBean> datas) {
        this.context = context;
        this.datas = datas;
    }

    @Override
    public ShopGiftBrithdayAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = View.inflate(context, R.layout.item_shop_gift_brithday, null);
        ShopGiftBrithdayAdapter.MyViewHolder view = new ShopGiftBrithdayAdapter.MyViewHolder(item);
        return view;
    }

    @Override
    public void onBindViewHolder(ShopGiftBrithdayAdapter.MyViewHolder holder, int position) {
