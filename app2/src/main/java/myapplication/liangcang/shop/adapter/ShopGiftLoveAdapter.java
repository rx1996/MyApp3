...
public class ShopGiftLoveAdapter extends RecyclerView.Adapter<ShopGiftLoveAdapter.MyViewHolder> {
    private final Context context;
    private final List<GiftLoveInfo.DataBean.ItemsBean> datas;

    public ShopGiftLoveAdapter(Context context, List<GiftLoveInfo.DataBean.ItemsBean> datas) {
        this.context = context;
        this.datas = datas;
    }

    @Override
    public ShopGiftLoveAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = View.inflate(context, R.layout.item_shop_gift_love, null);
        ShopGiftLoveAdapter.MyViewHolder view = new ShopGiftLoveAdapter.MyViewHolder(item);
        return view;
    }

    @Override
    public void onBindViewHolder(ShopGiftLoveAdapter.MyViewHolder holder, int position) {
