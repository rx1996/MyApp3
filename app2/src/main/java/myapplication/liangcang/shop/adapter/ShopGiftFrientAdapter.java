...
public class ShopGiftFrientAdapter extends RecyclerView.Adapter<ShopGiftFrientAdapter.MyViewHolder> {
    private final Context context;
    private final List<ShopGiftFriendInfo.DataBean.ItemsBean> datas;

    public ShopGiftFrientAdapter(Context context, List<ShopGiftFriendInfo.DataBean.ItemsBean> datas) {
        this.context = context;
        this.datas = datas;
    }

    @Override
    public ShopGiftFrientAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = View.inflate(context, R.layout.item_shop_gift_friend, null);
        ShopGiftFrientAdapter.MyViewHolder view = new ShopGiftFrientAdapter.MyViewHolder(item);
        return view;
    }

    @Override
    public void onBindViewHolder(ShopGiftFrientAdapter.MyViewHolder holder, int position) {
