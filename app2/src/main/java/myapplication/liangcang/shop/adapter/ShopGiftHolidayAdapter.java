...
public class ShopGiftHolidayAdapter extends RecyclerView.Adapter<ShopGiftHolidayAdapter.MyViewHolder> {


    private final Context context;
    private final List<GiftHolidayInfo.DataBean.ItemsBean> datas;


    public ShopGiftHolidayAdapter(Context context, List<GiftHolidayInfo.DataBean.ItemsBean> datas) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = View.inflate(context, R.layout.item_shop_gift_holiday, null);
