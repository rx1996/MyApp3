...
public class ShopGiftParentAdapter extends RecyclerView.Adapter<ShopGiftParentAdapter.MyViewHolder> {
    private final Context context;
    private final List<GiftParentInfo.DataBean.ItemsBean> datas;

    public ShopGiftParentAdapter(Context context, List<GiftParentInfo.DataBean.ItemsBean> datas) {
    ...
    @Override
    public ShopGiftParentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = View.inflate(context, R.layout.item_shop_gift_parent, null);
        ShopGiftParentAdapter.MyViewHolder view = new ShopGiftParentAdapter.MyViewHolder(item);
        return view;
    }

    @Override
    public void onBindViewHolder(ShopGiftParentAdapter.MyViewHolder holder, int position) {
